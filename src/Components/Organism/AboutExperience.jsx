  ...
  return (
    <div className="mt-20 sm:mt-0 sm:w-1/2 ">
      ...
      <Timeline active={1} bulletSize={22} lineWidth={6}>
        <Timeline.Item title="PT. Phincon" variant="unstyled" className="font-semibold text-xl">
          <h2 className="font-poppins text-sm  font-semibold text-primary ml-3">
            Frontend Web Developer<span className="text-black font-normal">- Magang</span>
          </h2>
          <p className="font-poppins text-sm  font-normal text-gray-500 mt-1 ml-3">Feb 2024  - Jul 2024</p>
        </Timeline.Item>
